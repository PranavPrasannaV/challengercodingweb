...
import { allCourses, java2Lessons } from "@/lib/courses";

export default function Java2Tutorials() {
    return (
        <>
            <Navbar />
            <Hero title="Advanced Java Programming" subtitle="Master advanced Java concepts and object-oriented programming." />
            ...
            <div style={{ maxWidth: "1200px", margin: "4rem auto", padding: "0 1rem" }}>
                ...
                <div style={{ textAlign: "center", marginTop: "2rem" }}>
                    <Link href="/tutorials/java2/test">
